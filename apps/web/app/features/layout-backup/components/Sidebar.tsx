...
interface SidebarProps {
    currentView: 'collections' | 'dashboard' | 'settings-page'
    setView: (view: 'collections' | 'dashboard' | 'settings-page') => void
    ...
    return (
        <div className="dbx-sidebar dark">
            ...
            <SidebarItem
                ...
                tooltip="Dashboard - View analytics and insights"
            ...
            <SidebarItem
                ...
                tooltip="Settings - Configure application preferences"
                isActive={currentView === 'settings-page'}
                onClick={() => {
